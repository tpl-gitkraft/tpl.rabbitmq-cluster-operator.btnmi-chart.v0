...
# Your Private Fork of GitKraft's `rabbitmq-cluster-operator` Helm Chart
...
[rabbitmq-cluster-operator Helm chart](https://github.com/gitkraft/rabbitmq-cluster-operator.btnmi-chart.v0),
